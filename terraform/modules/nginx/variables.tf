...
variable "subnet_id" {
  description = "OCID of the public subnet for the Nginx instance."
  type        = string
}

variable "nsg_ids" {
  description = "List of NSG OCIDs for the Nginx instance."
  type        = list(string)
  default     = []
}

variable "availability_domain" {
  description = "Availability domain for the Nginx instance."
  type        = string
}

variable "instance_shape" {
  description = "OCI shape for the Nginx instance (Always Free eligible only)."
  type        = string
...
variable "backend_ip" {
  description = "Private IP of the Spring Boot application instance."
  type        = string
}
